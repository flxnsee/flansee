...
// tiny "creature language" greetings — typed near a lifeform when it wakes
const GREETINGS = {
  inhabitant: "…oh. hello, you.",
  specimens:  "psst — look what grew.",
  instincts:  "≋ feel that hum?",
  migrations: "i've wandered far.",
  signal:     "✦ say something?",
  echo:       "you really looked.",
};
...
export const ASCII = {
  ...
  BLOB_FRAMES, SPIRIT_FRAMES, TINY, SPECIMEN_ART, NODE_ART, GREETINGS, DECO,
};
